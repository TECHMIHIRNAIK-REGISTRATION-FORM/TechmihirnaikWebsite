...
<%
    try {
        ...
        st.executeUpdate("INSERT INTO `techmihirnaik`.`websitedesign` (`Name`, `Company`, `Email`, `Designation`, `CallingNumber`, `WhatsappNumber`, `Description`, `PreferredCallTime`) VALUES ('"+name+"', '"+company_name+"', '"+email+"', '"+designation+"','"+phone_call+"', '"+phone_whatsapp+"', '"+description+"', '"+time+"');");
